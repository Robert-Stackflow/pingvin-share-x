export default {
  ...
  "home.bullet.a.description": "Betreibe Share auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da Share mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL Share verfügbar ist",
  ...
  "admin.config.cache.redis-enabled.description": "Normalerweise speichert Share Infos im Speicher. Wenn du mehrere Instanzen von Share laufen hast, musst du Redis Caching aktivieren, damit der Cache zwischen den Instanzen geteilt wird.",
