export default {
  ...
  "navbar.links.assets": "我的资源",
  "navbar.links.shortLinks": "短链接",
  "navbar.links.reverse": "投递箱",
  ...
  "account.assets.description.empty": "创建文本或链接资源即可开始。",
  "account.assets.type.file": "文件",
  "account.assets.type.text": "文本",
  "account.assets.type.link": "链接",
  "account.assets.form.file": "文件",
  "account.assets.form.content": "文本",
  "account.assets.form.url": "URL",
  "account.assets.table.type": "类型",
  "account.assets.table.value": "内容",
  "account.assets.table.createdAt": "创建于",
  "account.assets.table.size": "大小",
  "account.assets.modal.delete.title": "删除资源",
  "account.assets.modal.delete.description": "你真的想删除这个资源吗？",
  "account.assets.notify.created": "资源已创建",
  "account.assets.notify.deleted": "资源已删除",
  "account.assets.notify.cloned": "资源已复制",
  "account.assets.notify.shareCreated": "共享已创建",
  "account.assets.notify.shortLinkCreated": "短链接已创建",
  "account.assets.notify.sentToRoom": "资源已发送到房间",
  "account.assets.action.more": "资源操作",
  "account.assets.action.preview": "预览",
  "account.assets.action.copy": "复制内容或链接",
  "account.assets.action.createShare": "创建共享",
  "account.assets.action.createShortLink": "创建短链接",
  "account.assets.action.sendToRoom": "发送到房间",
  "account.assets.action.clone": "复制资源",
  "account.assets.preview.title": "预览资源",
  "account.assets.preview.file.unsupported": "此文件类型无法预览。",
  "account.assets.sendToRoom.title": "发送资源到房间",
  "account.assets.sendToRoom.select": "房间",
  "account.assets.sendToRoom.empty": "请先创建房间再发送资源。",
  "account.assets.source.upload": "上传",
  "account.assets.source.share": "共享",
  "account.assets.source.room": "房间",
  "account.assets.source.inbox": "收件箱",
  "account.assets.filter.search": "搜索资源",
  "account.assets.filter.type.all": "全部类型",
  "account.assets.filter.source.all": "全部来源",
  "account.assets.filter.favorite": "仅收藏",
  "account.assets.filter.tag.all": "全部标签",
  "account.assets.sort.createdAt_desc": "最新优先",
  "account.assets.sort.createdAt_asc": "最早优先",
  "account.assets.sort.lastAccessedAt_desc": "最近使用",
  "account.assets.sort.name_asc": "名称（A–Z）",
  "account.assets.action.favorite": "切换收藏",
  "account.assets.action.manageTags": "管理标签",
  "account.assets.tags.modal.title": "管理标签",
  "account.assets.tags.modal.label": "标签",
  "account.assets.tags.modal.placeholder": "输入标签后按回车添加",
  "account.assets.notify.tagsUpdated": "标签已更新",
  "account.assets.notify.favorited": "收藏已更新",
  // END /account/assets

  // /account/activity
  "account.activity.title": "我的动态",
  "account.activity.table.time": "时间",
  "account.activity.table.action": "操作",
  "account.activity.table.target": "对象",
  "account.activity.table.detail": "详情",
  "account.activity.filter.action": "操作",
  "account.activity.filter.target": "对象类型",
  "account.activity.filter.all": "全部",
  "account.activity.empty": "暂无动态。",
  "account.activity.action.asset.create": "创建资产",
  "account.activity.action.asset.delete": "删除资产",
  "account.activity.action.asset.clone": "复制资产",
  "account.activity.action.share.create": "创建分享",
  "account.activity.action.share.complete": "完成分享",
  "account.activity.action.share.delete": "删除分享",
  "account.activity.action.shortLink.create": "创建短链",
  "account.activity.action.shortLink.visit": "短链被访问",
  "account.activity.action.shortLink.delete": "删除短链",
  "account.activity.action.inbox.create": "创建投递箱",
  "account.activity.action.inbox.submission": "收到投递",
  "account.activity.action.inbox.accept": "接收投递",
  "account.activity.action.inbox.reject": "拒绝投递",
  "account.activity.target.asset": "资产",
  "account.activity.target.share": "分享",
  "account.activity.target.shortLink": "短链",
  "account.activity.target.inbox": "投递箱",
  "account.activity.target.inboxSubmission": "投递记录",
  ...
  "account.shortLinks.type.internal": "站内路径",
  "account.shortLinks.form.target": "目标",
  "account.shortLinks.form.title": "标题",
  "account.shortLinks.form.code": "自定义短码",
  "account.shortLinks.list.title": "我的短链接",
  "account.shortLinks.empty": "还没有短链接。",
  "account.shortLinks.table.code": "短码",
  "account.shortLinks.table.target": "目标",
  "account.shortLinks.table.visits": "访问",
  "account.shortLinks.table.status": "状态",
  "account.shortLinks.status.active": "启用",
  "account.shortLinks.status.disabled": "停用",
  ...
  "account.shortLinks.stats.title": "分析",
  "account.shortLinks.stats.empty": "选择一个短链接查看分析。",
  "account.shortLinks.stats.totalVisits": "总访问",
  "account.shortLinks.stats.uniqueVisitors": "唯一访客",
  "account.shortLinks.stats.lastVisit": "最近访问",
  ...
  "account.shortLinks.stats.referer": "来源",
  "account.shortLinks.stats.userAgent": "用户代理",
  "account.shortLinks.notify.created": "短链接已创建",
  "account.shortLinks.notify.updated": "短链接已更新",
  "account.shortLinks.notify.enabled": "短链接已启用",
  "account.shortLinks.notify.disabled": "短链接已停用",
  "account.shortLinks.notify.deleted": "短链接已删除",
  "account.shortLinks.modal.delete.title": "删除短链接",
  "account.shortLinks.modal.delete.description":
    "你真的想删除短链接 {code} 及其访问日志吗？",

  // END /account/short-links

  // /clipboard
  "clipboard.title": "房间",
  "clipboard.auth.title": "登录后使用房间",
  "clipboard.auth.description": "私人房间和共享房间需要登录后使用。",
  "clipboard.private.title": "私人房间",
  "clipboard.private.badge": "私有",
  "clipboard.asset.type.file": "文件",
  "clipboard.asset.type.text": "文本",
  ...
  "clipboard.assets.count": "{count} 条内容",
  "clipboard.assets.table.type": "类型",
  "clipboard.assets.table.value": "内容",
  "clipboard.assets.table.createdAt": "创建于",
  "clipboard.assets.modal.delete.title": "删除房间内容",
  "clipboard.assets.modal.delete.description": "该房间内容将被永久删除。",
  "clipboard.rooms.create.title": "创建房间",
  "clipboard.rooms.create": "创建房间",
  "clipboard.rooms.name": "房间名称",
  "clipboard.rooms.passcode": "口令",
  "clipboard.rooms.title": "我的房间",
  "clipboard.rooms.manage": "房间管理",
  "clipboard.rooms.visited": "访问过的房间",
  "clipboard.rooms.visited.empty": "还没有访问过的房间。",
  "clipboard.rooms.empty": "还没有房间。",
  "clipboard.rooms.count": "个房间",
  "clipboard.rooms.id": "房间 ID",
  "clipboard.rooms.status": "状态",
  "clipboard.rooms.items": "内容数",
  "clipboard.rooms.protected": "有口令",
  "clipboard.rooms.open": "公开",
  "clipboard.rooms.delete.title": "删除房间",
  "clipboard.rooms.delete.description":
    "房间 {room} 和其中的内容将被永久删除。",
  "clipboard.rooms.edit.title": "编辑房间",
  "clipboard.rooms.editor.title": "房间",
  "clipboard.rooms.editor.empty": "创建或选择一个房间后添加内容。",
  "clipboard.rooms.select": "选择房间",
  "clipboard.rooms.passcode.keep": "留空则保留当前口令。",
  "clipboard.rooms.passcode.remove": "移除口令",
  "clipboard.notify.asset-created": "房间内容已添加",
  "clipboard.notify.asset-deleted": "房间内容已删除",
  "clipboard.notify.room-created": "房间已创建",
  "clipboard.notify.room-deleted": "房间已删除",
  "clipboard.notify.room-updated": "房间已更新",
  "clipboard.room.title": "房间",
  "clipboard.room.locked.title": "需要口令",
  "clipboard.room.passcode": "口令",
  "clipboard.room.unlock": "解锁房间",
  "clipboard.room.notify.verified": "房间已解锁",
  ...
  "account.reverseShares.description.empty": "你还没有创建任何投递箱",
  // showCreateReverseShareModal.tsx
  "account.reverseShares.modal.title": "创建投递箱",
  ...
  "account.reverseShares.submissions.pending": "待处理投递",
  "account.reverseShares.submissions.empty": "暂无待处理投递。",
  "account.reverseShares.submissions.assets": "资产",
  "account.reverseShares.submissions.message": "留言",
  "account.reverseShares.submissions.noMessage": "无留言",
  "account.reverseShares.submissions.acceptAssets": "接收到资产",
  "account.reverseShares.submissions.acceptShare": "接收为共享",
  ...
  "account.reverseShares.submissions.notify.acceptedAssets": "投递已接收到你的资产",
  ...
  // /admin/activity
  "admin.activity.title": "操作日志",
  "admin.activity.table.actor": "操作者",
  // END /admin/activity
  ...
  "admin.users.edit.password.action": "更改密码",
  "admin.users.edit.password.title": "更改密码 {username}",
  ...
  "upload.modal.content.title": "共享内容",
  ...
  "upload.modal.content.text.label": "文本内容",
  "upload.modal.content.text.placeholder": "粘贴一段备注或文本片段",
  "upload.modal.content.text.add": "添加文本",
  "upload.modal.content.text.empty": "还没有添加文本。",
  "upload.modal.content.link": "链接",
  "upload.modal.content.link.label": "链接地址",
  "upload.modal.content.link.add": "添加链接",
  "upload.modal.content.link.empty": "还没有添加链接。",
  "upload.modal.content.link.invalid": "请输入带协议的有效 URL。",
  "upload.modal.inbox.submit": "提交",
  "inbox.submission.created": "投递已提交",
  "upload.modal.details.title": "基本信息",
  "upload.modal.details.name.placeholder": "名称",
  "upload.modal.details.description.placeholder": "写给接收者的备注",
  "upload.modal.access.expiration.title": "过期设置",
  "upload.modal.access.email.title": "邮件提醒",
  "upload.modal.access.email.placeholder": "收件人电子邮件地址",
  "upload.modal.access.email.invalid-email": "邮件地址不可用",
  "upload.modal.access.security.title": "访问控制",
  "upload.modal.access.security.password.label": "密码保护",
  "upload.modal.access.security.password.placeholder": "无密码",
  "upload.modal.access.security.max-views.label": "最大访问次数",
  ...
  "admin.config.s3.file-rename-rules.glob": "通配符",
  "admin.config.s3.file-rename-rules.regex": "正则",
  "admin.config.s3.file-rename-rules.add": "添加规则",
  ...
  "accessControl.password": "密码",
  "accessControl.password.placeholder": "留空表示无密码",
  "accessControl.expiresAt": "过期时间",
