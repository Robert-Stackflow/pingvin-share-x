export default {
  ...
  "home.bullet.a.description": "Hosta Share på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad Share med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL Share finns",
  ...
  "admin.config.cache.redis-enabled.description": "Normalt sett cachar Share information i minnet. Om du kör flera instanser av Share måste du aktivera Redis-cachning för att dela cachen mellan instanserna.",
