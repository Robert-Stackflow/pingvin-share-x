export default {
  ...
  "home.bullet.a.description": "Hosti Share oma seadmes.",
  ...
  "admin.config.config-file-warning.description": "Kuna teil on konfigureeritud Share konfiguratsioonifailiga, ei saa te muuta konfiguratsiooni kasutajaliidest kasutades.",
  ...
  "admin.config.general.app-url.description": "URL, mille kaudu Share on kättesaadav",
