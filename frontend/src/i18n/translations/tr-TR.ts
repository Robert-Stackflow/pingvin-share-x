export default {
  ...
  "home.bullet.a.description": "Share'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "Share'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "Share'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde Share bilgileri bellekte önbellekler. Birden fazla Share örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
