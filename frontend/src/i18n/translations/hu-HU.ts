export default {
  ...
  "home.bullet.a.description": "A Share megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Share megosztáskezelőre mutató hivatkozás",
