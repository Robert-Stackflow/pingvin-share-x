export default {
  ...
  "home.bullet.a.description": "Hospede o Share em sua própria máquina.",
  ...
  "admin.config.config-file-warning.description": "Como você tem um Share configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o Share está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches Share na memória. Se você executar várias instâncias do Share, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
